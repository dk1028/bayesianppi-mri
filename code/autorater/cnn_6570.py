...
# 1) Settings
CSV_PATH    = Path(r"C:\Users\AV75950\Documents\matched_cn_ad_labels.csv")
...
# Create H column at the very end of the feature construction:
# label == "AD" → 1, label == "CN" → 0
...
# Copy test_df (already has H) and attach predictions
out_df = test_df.copy().reset_index(drop=True)
out_df['autorater_prediction'] = test_preds
# Ensure H is 0/1 integer
out_df['H'] = out_df['H'].astype(int)

out_df.to_csv("autorater_predictions1.csv", index=False)
print("✅ autorater_predictions1.csv generated")
...
df_out.to_csv("autorater_predictions_all1.csv", index=False)
print("✅ autorater_predictions_all1.csv generated")
