# -*- coding: utf-8 -*-
"""implementaion_coverage_all.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1VNA7_ABUHime-tCmjqr_f12qDXmqxqMl
"""
...
CSV_PATH = '/content/drive/MyDrive/age_analysis/autorater_predictions_all4.csv'  # <- 여기 파일 사용
...
# 2) Chain-rule Estimator (사전 α,β를 인자로)
...
# 4.5) PPI (analytic) — 수식 CI: Var(A)/N + Var(H−A)/n
def ppi_analytic_estimator(labeled_idx):
    Z975 = 1.959963984540054  # 95% 양측 CI용 z
    # 전체 풀의 A (binary) 평균과 분산
...
# 6) 결과 저장 및 출력 (그대로 콘솔에 보여주기)
res_df = pd.DataFrame(all_results)
# 필요시 드라이브에 저장하려면 아래 주석 해제:
...
CSV_PATH = '/content/drive/MyDrive/age_analysis/autorater_predictions_all4.csv'  # <- use this file
