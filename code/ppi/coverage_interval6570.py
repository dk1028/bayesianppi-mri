...
CSV_PATH = COVERAGE_ROOT / "coverage_6570.csv"
if not CSV_PATH.exists():
    raise FileNotFoundError(f"Run implementaion_coverage_6570.py first: {CSV_PATH} not found")
...
plt.grid(True)
plt.tight_layout()
plt.savefig(FIGS_ROOT / "fig_interval_6570.pdf", bbox_inches="tight")
plt.savefig(FIGS_ROOT / "fig_interval_6570.png", dpi=300, bbox_inches="tight")
plt.close()
